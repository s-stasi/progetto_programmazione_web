...
<main class="page-body">
  ...
  <div class="ricerca-box">
      <form method="GET" action="search_umbrella.php" class="form-ricerca-inline">
          ...
          <a href="search_umbrella.php" class="btn-reset">Resetta</a>
      </form>
  </div>
              ...
              <?php if ($result && $result->num_rows > 0): ?>
                  <?php while($row = $result->fetch_assoc()): ?>
                      ...
                      <tr>
                          ...
                          <td>
                              <a href="search_umbrella.php?settore=<?= $row['settore'] ?>">
                                  <?= $lettera_settore ?>
                              </a>
                          </td>
                          <td><?= $row['numFila'] ?></td>
...
<script src="javascript/search_umbrella.js"></script>
