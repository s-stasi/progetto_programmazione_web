...
@MultipartConfig
public class ClienteApiServlet2 extends HttpServlet {
  ...
  // Constructs the JSON containing the contract history
  private void handleGetContracts(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      ...
      // Manual construction of the JSON expected by the frontend
